...
init offset = -1
##标题菜单和游戏菜单使用的图像
define gui.main_menu_background = "gui/封面.jpg"
define gui.game_menu_background = "gui/封面.jpg"
...
style window:
    ...
    background Image("gui/phone/textbox.png", xalign=0.5, yalign=0.5)
...
style namebox:
    ...
    background Frame("gui/phone/textbox.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
